...
LOOK_AHEAD_FILTERED_SERIES = 25     # look ahead for better peak in 1st step on filtered series
DELTA_FILTERED_SERIES = 2           # x delta, e.g. 5 mean only every 5 on x axes can be peak
LOOK_AHEAD_RAW_SERIES = 25         # look ahead for better peak in 2nd step on raw series
