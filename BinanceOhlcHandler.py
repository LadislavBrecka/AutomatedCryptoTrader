...
class BinanceOhlcHandler(OhlcHandler):
    ...
    def get_dataset(self):
        if self.interval == '1':
            raw_data = self.binance_client.get_historical_klines(self.pair, Client.KLINE_INTERVAL_1MINUTE, "2 hours ago UTC")
        elif self.interval == '5':
            raw_data = self.binance_client.get_historical_klines(self.pair, Client.KLINE_INTERVAL_5MINUTE, "50 hours ago UTC")
