...
# Not used in project, need some refactoring
class CoinMarketCapHandler:
    ...
    # Function for getting actual data abut selected coin
    def get_actual(self):
        coins = {}
    ...
    # Function for getting historical data of selected coin from CoinMarketCap
